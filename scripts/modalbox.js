    ...
    $.fn.myOwnDialog = function(options) {
        if (options === "open") {
            return this.each(function() {
                ...
                let dialod_video = $(this).attr("data-dialogVideo")
                ...
                $(this).find(".close").on("click", function() {
                    if (dialod_video === "true") {
                        $moDialog.find(".to_stop_" + dialog_id).each(function(){
                ...
                if (dialod_video === "true") {
                    $(this).find( "iframe" ).addClass("to_stop_"+dialog_id)
                }
            ...
            return this.each(function() {
                ...
                $moDialog.attr("data-dialogVideo", settings.video);
